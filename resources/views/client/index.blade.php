        ...
        <div id="sequence">
            ...
            <ul class="sequence-canvas">
                <li class="animate-in">
                    ...
                    <div class="flat-image formBottom delay200" data-duration="5" data-bottom="true"><img src="{{ asset('asset/client/images/—Pngtree—abstract line drawing female ballerina_6125309.png') }}" alt=""></div>
                </li>
                <li>
                    <div class="flat-caption caption3 formLeft delay500 text-center">
                        <p>Chào mừng đến với shop thời trang của chúng tôi - nơi cung cấp các sản phẩm đa dạng và chất lượng cao. Đến với chúng tôi để tìm kiếm phong cách của bạn!</p>
                    ...
                    <div class="flat-image formBottom delay200" data-bottom="true"><img src="{{ asset('asset/client/images/pngegg.png') }}" alt=""></div>
                </li>
            </ul>
        </div>
    </div>
